...
const ConferenceEvent = () => {
    ...
    // console.log('venueItems: ', venueItems);
    // console.log('avItems: ', avItems);
    // console.log('meals: ', mealsItems);
    ...
    const handleMealSelection = (index) => {
       ...
       if (item.selected && item.type === "mealForPeople") {
        // Ensure numberOfPople is set before toggling selection
                        ...
                        <div id="meals" className="venue_container container_main">
                            ...
                            <div className="meal_selection">
                                {mealsItems.map((item, index) => (
                                    <div classNme="meal_item" key={index} style={{padding: 15}}>
                                        <div className="inner">
